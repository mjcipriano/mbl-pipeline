...
--   hsp_strand (the strand that this hsp is on 1, 0, or -1)--   hsp_frame (the frame that this hsp is on, one of 0, 1, 2)
--   sequence_type_id -> sequence_types.id
...
) ENGINE=MyISAM AUTO_INCREMENT=571936 DEFAULT CHARSET=latin1 MAX_ROWS=4294967295 AVG_ROW_LENGTH=500;
...
CREATE TABLE `links` (
  ...
  UNIQUE KEY `super_id` (`super_id`,`ordinal_number`),
  KEY `links_ordinal_number` (`ordinal_number`),
  KEY `super_id_2` (`super_id`,`contig_number`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=5661 DEFAULT CHARSET=latin1;
...
CREATE TABLE `sequence_search` (
  ...
  `translate` char(1) default NULL,
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=2983 DEFAULT CHARSET=latin1;
